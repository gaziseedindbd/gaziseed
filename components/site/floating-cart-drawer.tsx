...
export default function FloatingCartDrawer() {
  ...
  return (
    <>
      {open && (
        <div className={`fixed right-3 z-[91] w-[calc(100vw-1.5rem)] max-w-[350px] origin-bottom-right bottom-[5.5rem]  animate-[gaziCartIn_.2s_ease-out] sm:bottom-[5.75rem] sm:right-5">
