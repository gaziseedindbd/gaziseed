...
export function AllProductsPage() {
  ...
  return <div className="container-custom py-7 sm:py-10">
    <section className="relative mb-7 overflow-hidden rounded-[2rem] border border-primary/15 bg-gradient-to-br from-primary/10 via-card to-accent/10 px-5 py-7 sm:px-8 sm:py-9"><div className="absolute -right-16 -top-16 h-40 w-40 rounded-full bg-accent/15 blur-3xl" /><div className="relative"><span className="mb-2 inline-flex rounded-full bg-primary/10 px-3 py-1 text-[10px] font-black uppercase tracking-wider text-primary">GAZI SEED</span><h1 className="text-3xl font-black tracking-tight sm:text-4xl">{searchQuery ? `সার্চ: “${searchQuery}”` : 'সকল প্রোডাক্ট'}</h1><p className="mt-2 text-sm text-muted-foreground">আপনার প্রয়োজনের বীজ ও কৃষি পণ্য সহজেই খুঁজে নিন</p></div></section>
