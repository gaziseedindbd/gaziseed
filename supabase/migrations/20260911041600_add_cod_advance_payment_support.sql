ALTER TABLE public.orders
  ADD COLUMN IF NOT EXISTS payment_advance_amount numeric(10,2) NOT NULL DEFAULT 0;

ALTER TABLE public.orders
  ADD COLUMN IF NOT EXISTS payment_due_amount numeric(10,2) NOT NULL DEFAULT 0;
