...
const homeDesktopCtaFixStyles = `
  /* Exact desktop-only CTA fix: the CTA's current parent is the centered text block,
     so offset it to the banner's lower-right without changing mobile behavior. */
  @media (min-width: 768px) {
    .home-premium-scope .hero-wrap > div:not(.absolute) > .hero-inner > div:first-child .hero-btn {
      position: absolute !important;
      right: calc(92.3% - 28px) !important;
...
export default function Page() {
  return (
    <>
      ...
      <style dangerouslySetInnerHTML={{ __html: homeDesktopCtaFixStyles }} />
    </>
  );
}
